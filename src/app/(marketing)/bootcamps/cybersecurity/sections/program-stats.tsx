...
const stats: Stat[] = [
    {
        ...
        title: 'Qualification',
        description: 'Industry Certificate',
    },
    {
    ...
    },
    {
        ...
        title: 'Delivery',
        description: 'Weekly instruction, feedback, and support',
    },
    {
    ...
    },
    {
        ...
        title: 'Features',
        description: 'Flexible schedules and small class sizes (8 max)',
    },
    {
        icon: <DollarSign className="size-5" />,
        title: 'Value',
        description: 'Flexible, affordable, high-quality education',
    },
]
