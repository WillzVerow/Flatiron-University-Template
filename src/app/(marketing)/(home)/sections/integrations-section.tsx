                ...
                <div className="mx-auto w-full max-w-5xl px-6 xl:px-0">
                    <div className="mx-auto max-w-2xl space-y-4 text-center">
                        <span className="text-foreground font-mono text-sm uppercase">
                            <span className="text-muted-foreground">[03]</span> Tools &amp; Technologies
                        </span>
                        <h2 className="text-foreground mt-6 text-balance text-4xl font-semibold lg:text-5xl">Learn the tools top companies actually use</h2>
                        <p className="text-muted-foreground mb-6 text-balance text-lg">Our curriculum covers the platforms, languages, and frameworks that hiring managers look for — so you graduate ready to contribute on day one.</p>
                        <Button
                            variant="outline"
                            size="sm"
                            asChild>
                            <Link href="/bootcamps">Explore Programs</Link>
                        </Button>
                    </div>
                </div>
            </Container>
