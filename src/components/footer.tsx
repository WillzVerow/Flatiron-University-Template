            ...
            <div className="mx-auto max-w-6xl space-y-16 px-6">
                <div className="grid gap-12 md:grid-cols-5">
                    <div className="space-y-6 md:col-span-2 md:space-y-12">
                        ...
                        <p className="text-muted-foreground text-balance text-sm">Furman University and Flatiron School — hands-on tech education for the next generation.</p>
                    </div>
                ...
                <div className="flex flex-wrap justify-between gap-4">
                    <span className="text-muted-foreground text-sm">© {new Date().getFullYear()} Furman University x Flatiron School. All rights reserved.</span>
